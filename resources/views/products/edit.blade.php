                ...
                <div class="p-6 space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="sku" value="{{ old('sku', $product->sku) }}" required autocomplete="off"
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name', $product->name) }}" required autocomplete="off"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="cost_price" value="{{ old('cost_price', $product->cost_price) }}"
                                   required step="0.01" min="0" autocomplete="off"
                                   class="w-full border-slate-300 rounded">
                        </div>
